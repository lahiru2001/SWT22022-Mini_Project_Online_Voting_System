...
<div class="nice">
    <table>
        ...
        <div class="head1">
         ...
         <a href="login.php"><button class="button-85"><h3>Login<h3></button></a>  
...
<table style="padding:10px">
        <tr>          
            ...
            <td class="auto-style1"><h2>How It Works</h2>
                <ol>
...
<div class="home-container"> 
    ...
    <table style="margin-left:150px">
        <tr>          
            ...
            <td><h2>Join the Movement</h2>
           <p class="join">Ready to make your voice heard? join a community of engaged citizens who are shaping the future through the
